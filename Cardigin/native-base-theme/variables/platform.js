...
export default {
  ...
  // FooterTab
  tabBarTextColor: platform === "ios" ? "#A1A1A1" : "#A1A1A1",
  tabBarTextSize: platform === "ios" ? 10 : 11,
  activeTab: platform === "ios" ? "#00b9e3" : "#00b9e3",
  sTabBarActiveTextColor: "#00b9e3",
  tabBarActiveTextColor: platform === "ios" ? "#000" : "#000",
  tabActiveBgColor: platform === "ios" ? "#E4E4E4" : "#E4E4E4",

  // Header
  toolbarBtnColor: platform === "ios" ? "#00b9e3" : "#00b9e3",
  ...
  toolbarBtnTextColor: platform === "ios" ? "#00b9e3" : "#00b9e3",
  ...
  radioSelectedColorAndroid: "#00b9e3",
